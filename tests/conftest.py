...
@pytest.fixture
def sample_qb_csv_with_readthon(tmp_path):
    """QuickBooks CSV with a READTHON pass-through section, mixed-case on
    purpose to exercise case-insensitive matching in the default tests."""
    content = '''Setauket School PTA
Transaction Detail by Account
July 1-31, 2025
,,,,,,,,
